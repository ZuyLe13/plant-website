...
sr.reveal(".home__data, .about__top, .popular__top, .review__top, .review__swiper, .footer__icon, .footer__content, .copy_right")
sr.reveal(".home__image", { delay: 300, scale: 0.5 })
